...
pub const RES_UNIT: &str = "unit";
pub const RES_BOX: &str = "box";
pub const RES_NEIGHBORHOOD: &str = "neighborhood";
pub const RES_N_PIXELS: &str = "n_pixels";
pub const RES_N_NAN: &str = "n_nan";
pub const RES_POINTS: &str = "points";
pub const RES_FRAME: &str = "frame";
pub const HEADER_BUNIT: &str = "BUNIT";
pub const DEFAULT_PROBE_BOX: u32 = 5;
pub const LUT_SIZE: usize = 256;
pub const SCALE_MODE_MINMAX: &str = "minmax";
pub const SCALE_MODE_ZSCALE: &str = "zscale";
pub const SCALE_MODE_PERCENTILE: &str = "percentile";
pub const SCALE_MODE_USER: &str = "user";
pub const SCALE_MODE_MANUAL_ALIAS: &str = "manual";

pub const RES_IMAGE_REF: &str = "image_ref";
pub const RES_PLANE: &str = "plane";
pub const RES_KIND: &str = "kind";
pub const RES_REF: &str = "ref";
pub const RES_EXTVER: &str = "extver";
pub const RES_IS_DQ: &str = "is_dq";
pub const RES_IS_ERR: &str = "is_err";
pub const RES_DQ_REF: &str = "dq_ref";
pub const RES_ERR_REF: &str = "err_ref";
pub const RES_SOURCE_PATH: &str = "source_path";
pub const RES_DQ_TABLE: &str = "dq_table";
pub const RES_DQ: &str = "dq";
pub const RES_ERR: &str = "err";
pub const RES_BITS: &str = "bits";
pub const RES_NAMES: &str = "names";
pub const RES_TABLE: &str = "table";
pub const RES_TEXT: &str = "text";
pub const RES_FLAGS: &str = "flags";
pub const RES_BIT: &str = "bit";
pub const RES_DEFAULT_MASK: &str = "default_mask";
pub const RES_EXCLUSION_MASK: &str = "exclusion_mask";
pub const RES_MASKED: &str = "masked";
pub const RES_DQ_EXCLUDED: &str = "dq_excluded";
pub const PLANE_KIND_HDU: &str = "hdu";
pub const PLANE_KIND_ARRAY: &str = "array";
pub const REF_FRAGMENT_HDU: &str = "hdu=";
pub const REF_FRAGMENT_ARRAY: &str = "array=";
pub const EXTNAME_DQ: &str = "DQ";
