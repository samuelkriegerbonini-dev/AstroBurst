...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            cmd::regions::radial_profile_cmd,
            cmd::regions::line_cut_cmd,
            cmd::regions::sb_profile_cmd,
            cmd::regions::regions_import_cmd,
            cmd::regions::regions_export_cmd,
            cmd::visualization::apply_stf_render,
            cmd::visualization::compute_scale_limits_cmd,
            cmd::visualization::get_colormap_lut_cmd,
            cmd::visualization::probe_pixel_cmd,
            cmd::visualization::pixel_table_cmd,
            cmd::visualization::get_dq_flag_table_cmd,
            cmd::visualization::get_dq_mask_preview,
            ...
            cmd::processing::hdrmt_cmd,
            cmd::processing::hdrmt_composite_cmd,
            cmd::pixelmath::pixelmath_cmd,
            cmd::pixelmath::pixelmath_validate_cmd,
            cmd::cosmetic::cosmetic_correct_cmd,
            cmd::cosmetic::cosmetic_correct_batch_cmd,
            cmd::statistics::compute_statistics_cmd,
            cmd::statistics::compute_statistics_composite_cmd,
            cmd::statistics::evaluate_noise_batch_cmd,
            cmd::cube::get_cube_info,
            cmd::cube::get_cube_frame,
            cmd::cube::get_cube_spectrum,
            cmd::cube::get_cube_spectrum_region_cmd,
            cmd::cube::collapse_cube_range_cmd,
            cmd::cube::moment_maps_cmd,
            cmd::line_measure::measure_spectral_line_cmd,
            cmd::spectral::spectral_axis_cmd,
            cmd::spectral::radial_velocity_correction_cmd,
            cmd::cutout::export_cutout_cmd,
            cmd::catalog::catalog_cone_search_cmd,
            cmd::catalog::catalog_crossmatch_cmd,
            cmd::catalog::catalog_export_csv_cmd,
            cmd::astrometry::plate_solve_cmd,
            cmd::astrometry::get_wcs_info,
            cmd::astrometry::pixel_to_world_cmd,
            cmd::astrometry::world_to_pixel_cmd,
            cmd::astrometry::sky_separation_cmd,
            cmd::astrometry::check_pointing_overlap_cmd,
            cmd::astrometry::grid_lines_cmd,
            cmd::contours::contour_lines_cmd,
