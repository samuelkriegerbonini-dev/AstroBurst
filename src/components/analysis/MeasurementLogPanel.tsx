...
const TIME_END = 19;
const EMPTY_TEXT =
  "No measurements logged yet. Photometry clicks, batch runs, line measurements, time series and cross-matches are logged automatically; region statistics, profiles, sky separation, the pixel table and the statistics panel have a Log button.";
    ...
    <div className="ab-panel overflow-hidden">
      ...
      <div className="px-3 py-2 space-y-2">
        ...
        <div className="flex flex-wrap items-center gap-1.5">
          ...
          <button type="button" onClick={clear} disabled={entries.length === 0} className={SMALL_BUTTON_CLASS} title="Remove every row of the log, whatever the filters show">
            <Trash2 size={10} />
